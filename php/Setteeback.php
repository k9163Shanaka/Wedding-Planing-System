...
<div class="flower_title"><h3><a href="../html/Decorations.html">Decorations</a> | Setteeback</h3></div>

<div class="content_container">

<?php
	$sql="SELECT * FROM `package` WHERE pack_name='setteeback'";
...
?>	
	...
	<div class="content_box">
			...
			<h2 class="content_title"><?php echo $row["pack_title"]."<br>";?><br>
